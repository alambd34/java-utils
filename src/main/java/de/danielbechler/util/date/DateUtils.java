...
public final class DateUtils
{
	...
	/**
	 * Creates an (almost) ISO 8601 compliant {@link java.text.DateFormat} using the UTC time zone. It takes
	 * the liberty to add the milliseconds to the formatted string.
	 * <p/>
